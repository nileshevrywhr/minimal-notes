...
![Alt Text](https://via.placeholder.com/1080x150 "Image Title")
...
![my pwnagotchi on a powerbank](https://via.placeholder.com/1080x150 "title that will be used a caption")

> pwnagotchi physical setup photo here [ (totally NOT an IED, and surprisingly passes undetected through x-ray baggage scanners)]
